...
# 2D code with rotation, Gaussian initial conditions, and Neumann boundary conditions (zero normal gradient)
...
ax2.set_title("Predators v(x,y,T)", pad=15)
ax2.set_xlabel("x")
ax2.set_ylabel("y")
ax2.set_zlabel("v")
...
def draw_frame(k):
    ...
    # rotation progressive (1 tour complet)
...
# Save as MP4
filename = os.path.expanduser("~/Desktop/LLLotka_volterra_2D_rotation.mp4")
